...
describe('UserService', () => {
  ...
  it('should call delete and return the deleted user', () => {
    ...
    const req1 = httpTestingController.expectOne('api/user/1'); // Vérifie l'URL avec l'id
  ...
  it('should call detail and return one user', () => {
    ...
    // Vérifier que la requête HTTP a été faite
    const req1 = httpTestingController.expectOne('api/user/1'); // Vérifie l'URL
    ...
    // Vérifier que la requête HTTP a été faite
    const req2 = httpTestingController.expectOne('api/user/2'); // Vérifie l'URL
